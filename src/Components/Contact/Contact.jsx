...
const footerData = [
    {
        id: 0,
        title: 'Mobile',
        display: '+91-9140858847',
        link: 'tel:+91-9140858847',
        icon: (
    ...
    },
    {
        id: 1,
        title: 'Email',
        display: 'priyaranjan16795@gmail.com',
        link: 'priyaranjan16795@gmail.com',
        icon: (
    ...
    },
    {
        ...
        icon: (
            <FaInstagram style={{ color: 'grey' }} className='commonIconsFooter' />
        ),
    },
    {
        id: 6,
        title: 'Medium',
        display: 'Medium',
        link: 'https://medium.com/@priyaranjan16795',
